                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Noida</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Freelance:</span>
                                <span className='text-LightGray md:text-sm'>Available</span>
                            </div>
                            {/* <div className="flex justify-between items-center">
                        ...
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>vikashjangir2301@gmail.com</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Linkedin:</span>
                                <span className='text-LightGray text-sm'>vikashjangir2301</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Phone:</span>
                                <span className='text-LightGray text-sm'>+91 8813848260</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    <a className='hover:scale-125 ease-in-out duration-700' href="mailto:vikashjangir2301@gmail.com" target='_blank' rel="noreferrer"><HiMail /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/vikash8813" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.linkedin.com/in/vikashjangir2301/" target='_blank' rel="noreferrer"><FaLinkedin /></a>
                ...
                <div className="my-12 w-full h-auto text-Snow">
                    ...
                    <div className="mt-4 py-8 px-8 bg-EveningBlack rounded-xl text-sm">
                        <div>
                            ...
                            <div className="my-4">
                                <button onClick={(e) => handleSubmit(e)} className="button"> SEND MESSAGE </button>
                            </div>
                        </div>
                    </div>
                </div>
